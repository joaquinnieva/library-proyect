...
import { INFO_BUTTON_PRY, INFO_BUTTON_SEC, INFO_SUBTITLE, INFO_TITLE1, INFO_TITLE2 } from '../../utils/constants';
    ...
    <section className="text-neutral-600 body-font">
      <div className="container flex flex-col items-center px-5 py-24 mx-auto md:flex-row">
        <div className="flex flex-col items-center mb-16 text-center lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left md:mb-0">
          ...
          <p className="mb-8 leading-relaxed dark:text-neutral-400">{INFO_SUBTITLE}</p>
